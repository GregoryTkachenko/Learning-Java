...
/*
Halting Condition
Just as loop can run into the problem of infinite looping,
...
which is the condition where the function stop calling itself.
In the previous example, the halting condition is when the parameter k becomes 0.

It is helpful to use a variety of different examples to better understand the concept.
In this example, the function adds a range of numbers between a start and end.
